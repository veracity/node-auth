 ...
 */
export declare type VIDPErrorCodes = "invalid_request" | "unauthorized_client" | "access_denied" | "unsupported_response_type" | "server_error" | "temporarily_unavailable" | "invalid_resource";
/**
...
export declare const isVIDPLoginResponse: (obj: any) => obj is IVIDPLoginResponseSuccess;
export declare const isVIDPAuthorizationCodeExchangeResponse: (obj: any) => obj is IVIDPAuthorizationCodeExchangeResponseSuccess;
export declare const isVIDPLoginResponseFailure: (obj: any) => obj is IVIDPLoginResponseFailure;
export declare const isVIDPResponseFailure: (obj: any) => obj is IVIDPAuthorizationCodeExchangeResponseFailure;
