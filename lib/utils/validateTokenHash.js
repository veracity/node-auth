 ...
 */
exports.validateTokenHash = (token, hash) => {
    const digest = crypto_1.default.createHash("sha256").update(token, "ascii").digest();
    const firstHalfBuffer = Buffer.alloc(digest.length / 2, digest);
    const computedHash = base64url_1.default(firstHalfBuffer);
